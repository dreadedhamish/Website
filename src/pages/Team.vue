				...
				<div class="grid w-full grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-4">
					<div class="flex flex-col items-center justify-center col-span-1">
						<div class="relative p-5">
							...
							<img class="relative z-20 w-full rounded-full" src="https://ipfs.io/ipfs/QmP61RC27XooEZxDU4W48qgFoxXoKP2wC37d7KoAffTvah" />
						</div>
					...
					<div class="flex flex-col items-center justify-center col-span-1">
						<div class="relative p-5">
							...
							<img class="relative z-20 w-full rounded-full" src="https://ipfs.io/ipfs/QmeEBZb4fUns8s5hxcSayp623Gr4JF5fNQkqoC5GKRjYXa" />
						</div>
						<div class="mt-3 space-y-2 text-center">
							<div class="space-y-1 text-lg font-medium leading-6">
								<h3>Madhav P</h3>
					...
					<div class="flex flex-col items-center justify-center col-span-1">
						<div class="relative p-5">
							...
							<img class="relative z-20 w-full rounded-full" src="https://ipfs.io/ipfs/QmbnXQuL5z7YnyjGTZDQz7gzGPkphSJSSMdACVy2BFAP5w" />
						</div>
						<div class="mt-3 space-y-2 text-center">
							<div class="space-y-1 text-lg font-medium leading-6">
								<h3>Suhail L</h3>
					...
					<div class="flex flex-col items-center justify-center col-span-1">
						<div class="relative p-5">
							<div class="absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-green-50"></div>
							<img class="relative z-20 w-full rounded-full" src="https://ipfs.io/ipfs/QmRxVvi1ggkPAptY61iRbRUFW3F6NVHQcLQBRvAtsrs4Jz" />
						</div>
						<div class="mt-3 space-y-2 text-center">
							<div class="space-y-1 text-lg font-medium leading-6">
								<h3>Paul G</h3>
					...
					<div class="flex flex-col items-center justify-center col-span-1">
						<div class="relative p-5">
							<div class="absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-blue-50"></div>
							<img class="relative z-20 w-full rounded-full" src="https://ipfs.io/ipfs/QmPGTHe88eQkKo8zNhE378LEApLtP3wnWeCJwfkCqAXF9f" />
						</div>
						<div class="mt-3 space-y-2 text-center">
							<div class="space-y-1 text-lg font-medium leading-6">
								<h3>Hamish E</h3>
								<p class="text-blue-600">PR Manager</p>
							</div>
						</div>
					</div>
				</div>
