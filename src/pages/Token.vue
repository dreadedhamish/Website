	...
	<section class="py-20">
		<div class="container mx-auto max-w-6xl px-10">
			<div class="grid grid-cols-1 text-gray-600 md:grid-cols-2 md:gap-16">
				<div class="col-span-1"><lottie-player autoplay="" loop="" mode="normal" src="https://bafybeiepaup45zzftco6aeh6iwncseg46tgokoi25nq2cy4ri64z7lzfiy.ipfs.infura-ipfs.io/" class="object-cover object-center w-full h-full" background="transparent"></lottie-player></div>
				<div class="col-span-1 m-auto">
					<h2 class="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading"><span class="text-white bg-red-400">THIRM</span> TOKEN</h2>
					...
					<div class="items-center mx-auto space-y-6 text-center">
						<div class="relative flex flex-col md:flex-row md:space-x-4">
							...
							<a href="https://etherscan.io/token/0xb526fd41360c98929006f3bdcbd16d55de4b0069" class="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">ETHERSCAN</a>
                                                        <a href="https://www.coingecko.com/en/coins/thirm-protocol" class="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">COINGECKO</a>
</div>
					</div>
				</div>
			</div>
