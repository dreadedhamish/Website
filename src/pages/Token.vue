		...
		<div class="container mx-auto max-w-6xl px-10">
			<div class="grid grid-cols-1 text-gray-600 md:grid-cols-2 md:gap-16">
				<div class="col-span-1">
					<lottie-player autoplay="" loop="" mode="normal" src="animation/token.json" class="object-cover object-center w-full h-full" background="transparent"></lottie-player></div>
